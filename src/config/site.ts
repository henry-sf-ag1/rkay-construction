export const siteConfig = {
  ...
  phone: "+44 1234 567 890", // PLACEHOLDER - Update with real number
  address: "London, United Kingdom", // PLACEHOLDER - Update with real address
  tagline: "Quality Residential Construction Across the UK",
  subtagline: "Extensions • Renovations • New Builds • Loft Conversions",
  social: {
    facebook: "#", // PLACEHOLDER - Add real URL
    instagram: "#", // PLACEHOLDER - Add real URL
